# Generated by Django 3.1.6 on 2024-01-25 22:13
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainApp', '0065_auto_20240125_2123'),
    ]

    operations = [
        migrations.CreateModel(
            name='ReportConfigTemplate',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pdf_form', models.CharField(default='FORM', max_length=50)),
                ('pdf_dn', models.CharField(default='DN', max_length=50)),
                ('pdf_dn_value', models.CharField(default='NOT ASSIGNED', max_length=20, unique=True)),
